...
explain_lines <- function(cont_var, cross_var_a, cross_var_b, resident, days_nz, filt_var, filt_val, year){
...
explain_bars <- function(cross_var_a, cross_var_b, resident, days_nz, filt_var, filt_val, year){
  cross_var_a_h <- paste0("<em>", cross_var_a, "</em>")
  cross_var_b_h <- paste0("<em>", cross_var_b, "</em>")
