...
----------------------------indexes------------------------
ALTER TABLE IDI_Sandpit.pop_exp_dev.fact_rollup_qtr ADD PRIMARY KEY (rollup_qtr_var_uid);

CREATE CLUSTERED INDEX c_person_date_var_q ON IDI_Sandpit.pop_exp_dev.fact_rollup_qtr(fk_snz_uid, fk_date_period_ending, fk_variable_code);          

CREATE COLUMNSTORE INDEX col_facts_q ON IDI_Sandpit.pop_exp_dev.fact_rollup_qtr
