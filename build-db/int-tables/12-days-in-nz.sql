...
As this involves a full cartesian join of the large spells_in_nz table with about 10,000 days of interest (all days from
...
WHILE @the_year > 1990
BEGIN
	EXECUTE pop_exp.estimate_days @yr = @the_year
