...
IF OBJECT_ID('IDI_Sandpit.pop_exp_dev.dim_explorer_value_year') IS NOT NULL
	DROP TABLE IDI_Sandpit.pop_exp_dev.dim_explorer_value_year;
GO

-- next object shouldn't exist anyway; old name for dim_explorer_value_year:
